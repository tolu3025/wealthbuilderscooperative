        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              ...
              {/* Main Heading */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 md:mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 mb-8 md:mb-12 max-w-3xl mx-auto px-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 md:mb-16 px-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                <Link to="/register">
                  <Button 
                    size="lg" 
                    className="w-full sm:w-auto bg-accent hover:bg-accent-light text-foreground font-semibold px-6 md:px-8 py-5 md:py-6 text-base md:text-lg shadow-lg hover:shadow-xl transition-all hover:scale-105"
                  >
                    Become a Member
                ...
                <Link to="/dashboard">
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-primary font-semibold px-6 md:px-8 py-5 md:py-6 text-base md:text-lg transition-all hover:scale-105"
                  >
                    Member Login
                  </Button>
                </Link>
              ...
              {/* Stats */}
              {!loading && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto px-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            {/* Feature Cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 px-4 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                <div 
                  key={index}
                  className="bg-card rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all hover:scale-105 border border-border"
                >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                ...
                "Regular dividend payments from property sales",
                "Build capital and savings simultaneously",
                "Referral commission for bringing new members",
                "Transparent financial tracking dashboard",
                "Withdrawal access after 6 months",
                "Community support and networking",
                "Professional financial management"
              ].map((benefit, index) => (
                <div 
                  key={index}
                  className="flex items-start gap-3 md:gap-4 p-4 md:p-6 bg-background rounded-xl border border-border hover:border-primary/50 transition-all"
                >
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 md:mb-10 px-4">
              {loading ? (
                ...
                `Join ${stats.memberCount}+ Nigerians who are already growing their wealth with WealthBuilders`
              ) : (
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <Link to="/register">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto bg-accent hover:bg-accent-light text-foreground font-semibold px-6 md:px-8 py-5 md:py-6 text-base md:text-lg shadow-lg"
                >
