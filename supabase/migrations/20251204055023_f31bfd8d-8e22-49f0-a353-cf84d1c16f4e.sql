-- Update admin_delete_user function to also delete MLM distributions 
-- and free up the tree slot (children go to grandparent, MLM earnings removed)
...
BEGIN
  ...
  IF v_profile_id IS NOT NULL THEN
    ...
    -- This preserves the tree structure and frees the deleted user's slot
    ...
    -- by removing MLM distributions from this user's PSF payments
    ...
    -- Only delete the user's own MLM tree record, children are already reassigned
